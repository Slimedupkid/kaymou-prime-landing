...
// Images mapped exactly to your file names
...
// Video mapped exactly to the capital C and .mov extension
import workVideo from "@/assets/Construction.mov";

const gallery = [
  { src: work1, alt: "Newly surfaced road with fresh line marking" },
  { src: work2, alt: "Asphalt driveway compaction in progress" },
  { src: work7, alt: "Steep driveway tar surfacing" },
  { src: work8, alt: "Team laying and compacting asphalt" },
  { src: work5, alt: "Kaymou team performing road repairs" },
  { src: work6, alt: "Interlocking paving alongside roadway" },
  { src: work9, alt: "Decorative pattern paving installation" },
  { src: work4, alt: "Completed tar surfacing at residential site" },
];
